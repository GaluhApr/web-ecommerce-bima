...
class ProductController extends Controller
{
    public function Store(Request $request)
    {
        ...
        $products->urldemo = $request->input('urldemo');
    ...
    public function category($id)
    {
        ...
        return view('categoryproducts', compact('Products', 'categories', 'id'));
    }
    ...
    public function allproducts(Request $request, $id = null)
    {
        ...
        return view('allproducts', compact('Products', 'categories', 'id'));
    }
}
