                ...
                <div class="carousel-inner">
                      ...
                      <div class="carousel-item active">
                            ...
                            <div class="view overlay">
                              ...
                              <div align="left" class="col-md-5 p-5 mx-5">
                                  <h1 class="black-text animated fadeInLeft slow " style="font-size:40px;">Buka Peluang Baru dengan Website Profesional Kami!
                                 </h1>
                              ...
                              <div class="col-md-3 animated fadeInRight slow">
                              <img class="img-fluid slideshowimage" src=" {{asset('slideshow/slide1-2.jpg')}}" alt="Slide-1" style="width:100%;">
                              </div>
                     ...
                     <div class="carousel-item">
                            <div class="view overlay">
                              <div class="row mx-5">
                              <div align="left" class="col-md-5 p-5 mx-5">
                                  <h1 class="black-text animated fadeInLeft slow " style="font-size:40px;">Website Handal untuk Hasil Maksimal!</h1>
                       ...
                       <div class="carousel-item">
                            ...
                            <br>
                                      <h1 class="black-text animated fadeInLeft slow " style="font-size:30px;">Lebih dari Sekadar Website - Solusi Bisnis Lengkap</h1>
                                      <div class="container">
                                          <div class="row ">
                       ...
                       <div class="carousel-item">
                            <div class="view overlay">
                                 <div align="center" class="p-5 " style="margin-top:-20px;">
                                      ...
                                      <h1 class="black-text animated fadeInLeft slow " > Tingkatkan Kepercayaan Pelanggan dengan Website Profesional! </h1>
