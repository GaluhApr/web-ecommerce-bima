...
<div align="center" style="background:#1CD5E8;padding:20px;">
    ...
    <p class="white-text" style="font-weight:bold;">
        ...
        <a href="{{url('admin-products')}}" class="badge badge-pill btn-outline-green     px-3 py-2"> <i class="fas fa-file-powerpoint"></i> &nbsp; Tampilkan semua produk</a>

        <a href="{{url('admin-add-product')}}" class="badge badge-pill btn-dark disabled  px-3 py-2"> <i class="fas fa-plus"></i> &nbsp; Tambah Produk</a>
        <a href="{{url('admin-bin-products')}}" class="badge badge-pill btn-outline-danger px-3 py-2"><i class="fas fa-dumpster"></i>Riwayat produk</a>
            ...
            <div class="card-body">
                <form method="POST" action="{{url('admin-store-product')}}" enctype="multipart/form-data">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="pstatus-tab" data-toggle="tab" href="#pstatus" role="tab" aria-controls="pstatus" aria-selected="false">Delivery Charges & Product Status</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="Additional_Information-tab" data-toggle="tab" href="#Additional_Information" role="tab" aria-controls="Additional_Information" aria-selected="false">Additional Information</a>
                        </li>
